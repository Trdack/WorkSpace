...
(function index() {
    ...
    (function () {
        ...
        if (Urlas.indexOf("http:") == -1) { //本地打开
            //console.log("本地打开！");
            var linknums = URLs.length - (URLs.indexOf("horts") + 1);
        } else { //站点打开
            //console.log("站点打开！");
    ...
    (function () {
        ...
        if (browser.versions.mobile || browser.versions.ios || browser.versions.android || browser.versions.iPhone || browser.versions.iPad) {
            ...
            Lcs = new linkscript();
            Lcs.Las = ["pc_index", "carousel1.1", "subject", "bottom"];
            Lcs.Sas = ["jquery-2.2.0.min", "scrollmouse", "top", "location", "carousel1.5", "browser-support", "bottom", "pc_css"];
            Lcs.funas();
        }
    })();
})();